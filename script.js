document.addEventListener('DOMContentLoaded', function() {
    ...
    const posts = {
        ...
        'all-about-love': {
            ...
            category: 'Category: Non-fiction Essays',
            date: 'Published: 15 Jan 2024',
            stars: 'My rating: ★★★☆☆',
            content: `
                <p>Sed ac dictum risus, in posuere quam. Ut fermentum enim ut sem lacinia, ac facilisis urna fermentum. Nulla facilisi. Morbi ut feugiat lorem.</p>
...
document.getElementById("searchButton").addEventListener("click", searchFunction);
    ...
    // Toggle Menu Functionality (if needed)
    function toggleMenu() {
    ...
    // Event listener for menu button (if needed)
    // document.querySelector('.menu-btn').addEventListener('click', toggleMenu);

    // Event listener for nav links to close menu (if needed)
